...
| cic.image | Mandatory | `quay.io/citrix/citrix-k8s-ingress-controller:1.2.0` | The CIC image. |
...
| defaultSSLCert | Optional | N/A | Default SSL certificate needs to be used as a non-SNI certificate in Citrix ADC. |
