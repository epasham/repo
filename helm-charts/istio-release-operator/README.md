...
[istio-release-operator](https://github.com/banzaicloud/istio-release-operator) is a canary deployment operator.
...
To uninstall/delete the `istio-release-operator` release:
